...
import com.demospringsecurity.controller.ValidateController;
import com.demospringsecurity.entity.SmsCode;
import com.demospringsecurity.exception.ValidateCodeException;
...
public class SmsCodeFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        if (request.getRequestURI().equalsIgnoreCase("/login/mobile")
    ...
    private void validateSmsCode(ServletWebRequest servletWebRequest) throws ServletRequestBindingException {
        ...
        if (smsCodeInRequest == null || smsCodeInRequest.isEmpty()) {
        ...
        if (codeInSession.getCode() != null && !codeInSession.getCode().equalsIgnoreCase(smsCodeInRequest)) {
