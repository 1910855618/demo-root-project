...
import com.demospringsecurity.entity.ImageCode;
...
public class ValidateController {
    ...
    public void createCode(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ImageCode imageCode = createCodeImage();
    ...
    public void createSmsCode(HttpServletRequest request, HttpServletResponse response, String mobile) throws IOException {
        ...
        // 输出验证码到控制台代替短信发送服务
        log.info("您的登录验证码为：{}，有效时间为60秒", smsCode.getCode());
    }
    ...
    private ImageCode createCodeImage() {
