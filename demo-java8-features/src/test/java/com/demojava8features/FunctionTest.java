...
public class FunctionTest {
    // 自定义函数式接口
    // @FunctionalInterface 是可选的，但加上该标注编译器会帮你检查接口是否符合函数接口规范
    @FunctionalInterface
    ...
    void functionTest() {
        ...
        // key 4 会被删除，应为 key 和映射的 value 完全比对上了
        map.remove(4, "four");
        ...
        // value 不是 null 所以会拼接映射到这个 key 中
        ...
        // key 不存在，会将 apply 实现方法中计算好的不为 null 的 value 与其关联
        ...
        // key 值存在并且 value != null 执行其中实现方法，结果为 null 删除 key，不是则将计算后的值与 key 绑定
